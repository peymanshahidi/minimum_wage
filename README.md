...
|-----|-------|
| economic_opening | An identifier for the job opening | REMOVED |
| team | Identifier if the employer is part of a larger team | REMOVED |
| first_opening | If employer posted multiple openings of this kind, the first one | REMOVED |
...
| url | Link to the job description | REMOVED |
